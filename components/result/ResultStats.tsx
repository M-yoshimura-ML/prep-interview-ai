...
export default function ResultTable({ interview }: { interview: IInterview }) {
    ...
    const durationData = calculateDuration(interview?.duration, interview?.durationLeft);
    ...
    return (
        <div className="grid w-full grid-cols-1 gap-5 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-5">
            {data.map((item, index) => (
